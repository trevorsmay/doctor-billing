...
//       API.getProcedures()
//       .then(res =>
//         this.setState({ procedures: res.data, qty: [], total: []})
//         )
...
//       const fee= 150
//       if (this.state.qty>0) {
//        this.state.total = this.state.qty*fee
//       } else {
//         (this.state.total=0)
//       }
//     };
...
//       const { name , value, fee} = event.target;
//       this.setState({
//         [name]: value,
//         [fee]: this.state.fee
//       });
...
//           <td>GP</td>
//           <td>
//           <Input name="qty" value={this.state.qty} placeholder="0" onChange={this.handleInputChange}/>
//           </td>
//           <td></td>
//           <td fee={150} onChange={this.handleInputChange}  value={this.state.fee} >$150</td>
...
//           <td>GP-59</td>
//           <td>
//             <Input value={this.state.qty} placeholder="0" onChange={this.handleInputChange}/>
//           </td>
//           <td></td>
//           <td>$12</td>
//           <td></td>
